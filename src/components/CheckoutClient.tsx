...
function CheckoutForm({
  ...
  const productSlugOrId = searchParams.get("product");
  const product = products.find(
    (p) =>
      p.id === productSlugOrId ||
      p.slug.vi === productSlugOrId ||
      p.slug.zh === productSlugOrId
  );
  ...
  if (!product) {
    return (
      <div className="pt-32 pb-20 text-center">
        ...
        <button
          onClick={() => router.push(`/${currentLang}/products`)}
              ...
              <div className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all text-slate-900"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-600 ml-1">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 rounded-xl border border-slate-200 focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all text-slate-900"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none transition-all resize-none text-slate-900"
                  ></textarea>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex gap-4 mb-6">
                <div className="w-20 h-20 rounded-xl overflow-hidden shrink-0 border border-slate-100 relative">
                  <Image src={product.image} alt={product.name[currentLang]} fill sizes="80px" className="object-cover" />
                </div>
                <div>
              ...
              <div className="space-y-3 mb-8">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-emerald-600 font-medium">
                    {currentLang === "vi" ? "Miễn phí" : "免费"}
                  </span>
                </div>
                <div className="pt-3 border-t border-slate-50 flex justify-between items-center">
                  <span className="font-bold text-slate-900">
                    {currentLang === "vi" ? "Tổng cộng" : "总计"}
                  </span>
...
export function CheckoutClient({
  ...
  return (
    ...
    >
      <CheckoutForm paramsPromise={params} />
    </Suspense>
  );
}
