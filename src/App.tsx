      ...
      <footer className="bg-slate-900 text-white py-12 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
          <div className="col-span-2">
            <h2 className="text-2xl font-serif font-bold text-gold mb-6">YẾN SÀO THỊNH VƯỢNG (YSTV)</h2>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400 text-sm">
              <li>
                <Link to={`/${lang}`} className="hover:text-gold transition-colors">
                  {t('nav.home')}
                </Link>
              </li>
              <li>
                <Link to={`/${lang}/products`} className="hover:text-gold transition-colors">
                  {t('nav.products')}
                </Link>
              </li>
              <li>
                <Link to={`/${lang}/about`} className="hover:text-gold transition-colors">
                  {t('nav.about')}
                </Link>
              </li>
              <li>
                <Link to={`/${lang}/blog`} className="hover:text-gold transition-colors">
                  {t('nav.blog')}
                </Link>
              </li>
              <li>
                <Link to={`/${lang}/contact`} className="hover:text-gold transition-colors">
                  {t('nav.b2b')}
                </Link>
              </li>
            </ul>
